export async function setup(ctx) {
    ...
    let versionNumber;
    if (ctx.version) {
        versionNumber = ctx.version.split("."); // could be undefined
    }
    ...
    const addToDropTable = (monsterID, chestOrMonster, patchFlag, newItems) => {
        ...
        if (chestOrMonster === "monster")
            ...
            emptyDrop = {
                item: game.items.getObjectByID("melvorD:Empty_Equipment"),
                weight: 0,
                vanillaWeight: 0,
                minQuantity: 0,
                maxQuantity: 0
        ...
        if (vanillaDrops[monsterID] === undefined) {
            let drops = []
            game[lootDropperKey].getObjectByID(monsterID)[tableKey].sortedDropsArray.forEach(drop => drops.push({
                item: drop.item,
                weight: drop.weight,
        ...
        newItems.forEach(item => {
            if (patchFlag) {
                ...
                game[lootDropperKey].getObjectByID(monsterID)[tableKey].drops = [...game[lootDropperKey].getObjectByID(monsterID)[tableKey].drops, {
                    item: game.items.getObjectByID(item.id),
                    maxQuantity: item.maxQuantity,
                    minQuantity: item.minQuantity,
                    weight: item.weight
                }] // Add new item. If there were empty drops before, the new item takes up empty drop slots. If there were no empty drops, or empty drops have been fully used up already, then the addition of this item reduces the drop rate of all other items (by increasing the total weight in the next step).
    ...
    const modifyDropTable = (monsterID, chestOrMonster, patchFlag, itemsToModify) => {
        ...
        if (vanillaDrops[monsterID] === undefined) {
            ...
            vanillaDrops[monsterID] = {
                'drops': drops,
                'totalWeight': game[lootDropperKey].getObjectByID(monsterID)[tableKey].totalWeight,
                'chestOrMonster': chestOrMonster
            }
        }
    ...
    const patchMonsterDrops = (patchFlag) => {
        // Bones
        patchBoneTable("melvorTotH:RaZu", patchFlag, {
        ...
        // Chests
        // Add
        addToDropTable("melvorTotH:Ancient_Chest", "chest", patchFlag, [{
            'id': "melvorTotH:Linden_Logs",
            'weight': 19,
            'minQuantity': 155,
            'maxQuantity': 365
        }])
        addToDropTable("melvorTotH:Burning_Chest", "chest", patchFlag, [{
        ...
        // Monsters
        // Add
        addToDropTable("melvorTotH:BurningSnake", "monster", patchFlag, [{
            "id": "melvorTotH:Divine_Helmet",
            "weight": 200,
            "minQuantity": 1,
            "maxQuantity": 1
        }])
        addToDropTable('melvorTotH:Manticore', 'monster', patchFlag, [{
            "id": "melvorTotH:Divine_Platelegs",
            "weight": 100,
            "minQuantity": 1,
            "maxQuantity": 1
        }])
        addToDropTable('melvorTotH:PoisonToad', 'monster', patchFlag, [{
            "id": "melvorTotH:Poison_Rune",
            "weight": 210,
            "minQuantity": 20,
            "maxQuantity": 60
        }])
        addToDropTable('melvorF:Valkyrie', 'monster', patchFlag, [{
            "id": "melvorF:Absorbing_Shield",
            "weight": 5,
            "minQuantity": 1,
            "maxQuantity": 1
        }])
        addToDropTable("melvorTotH:Phantom", "monster", patchFlag, [{
            "id": "melvorTotH:Soul_Rune",
            "minQuantity": 250,
            "maxQuantity": 500,
            "weight": 20000
        }])
        addToDropTable("melvorTotH:Spectre", "monster", patchFlag, [{
            "id": "melvorTotH:Soul_Rune",
            "minQuantity": 250,
            "maxQuantity": 500,
            "weight": 20000
        }])
        addToDropTable("melvorTotH:Banshee", "monster", patchFlag, [{
            "id": "melvorTotH:Soul_Rune",
            "minQuantity": 250,
            "maxQuantity": 500,
            "weight": 20000
        }])
        addToDropTable("melvorD:Golbin", "monster", patchFlag, [{
            'id': "melvorD:Shrimp",
            'weight': 100,
            'minQuantity': 1,
            'maxQuantity': 1
        }])
        addToDropTable('melvorF:Priest', 'monster', patchFlag, [{
            'id': "melvorF:Prayer_Scroll",
            'minQuantity': 1000,
            'maxQuantity': 1500,
            "weight": 500
        }])
        addToDropTable('melvorD:DarkWizard', 'monster', patchFlag, [{
            'id': "melvorF:Wizards_Scroll",
            'minQuantity': 1000,
            'maxQuantity': 1500,
            "weight": 500
        }])
        addToDropTable('melvorTotH:InfernalGolem', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorTotH:MagicFireDemon', 'monster', patchFlag, [{
            "id": "melvorTotH:Divine_Shield",
            "weight": 300,
            "minQuantity": 1,
            "maxQuantity": 1
        }])
        addToDropTable('melvorTotH:GretYun', 'monster', patchFlag, [{
            "id": "melvorTotH:Divine_Platebody",
            "weight": 100,
            "minQuantity": 1,
            "maxQuantity": 1
        }])
        addToDropTable("melvorTotH:FrostGolem", "monster", patchFlag, [{
        ...
        // Modify
        modifyDropTable('melvorTotH:InfernalGolem', 'monster', patchFlag, [{
            'id': "melvorTotH:Infernal_Rune",
            'minQuantity': 24,
            'maxQuantity': 40,
            'weight': 0
        }])
        modifyDropTable('melvorTotH:MagicFireDemon', 'monster', patchFlag, [{
            'id': "melvorD:Fire_Rune",
            'minQuantity': 9,
            'maxQuantity': 20,
            "weight": 0
        ...
        modifyDropTable('melvorTotH:GretYun', 'monster', patchFlag, [{
            'id': "melvorTotH:Infernal_Rune",
            'minQuantity': 19,
            'maxQuantity': 30,
            "weight": 0
        }])
        modifyDropTable("melvorTotH:FrostGolem", "monster", patchFlag, [{
            'id': "melvorD:Water_Rune",
            "weight": 0,
            'minQuantity': 34,
            'maxQuantity': 60
        ...
        modifyDropTable('melvorF:Priest', 'monster', patchFlag, [{
            'id': "melvorD:Light_Rune",
            'minQuantity': 9,
            'maxQuantity': 20,
            "weight": 0
        }])
        modifyDropTable('melvorD:DarkWizard', 'monster', patchFlag, [{
            'id': "melvorD:Chaos_Rune",
            'minQuantity': 14,
            'maxQuantity': 30,
            "weight": 0
        ...
        modifyDropTable('melvorD:MasterWizard', 'monster', patchFlag, [{
            'id': "melvorD:Mind_Rune",
            'minQuantity': 4,
            'maxQuantity': 0,
            "weight": 0
        }])
        modifyDropTable('melvorTotH:IceHydra', 'monster', patchFlag, [{
            'id': "melvorTotH:Calamity_Rune",
            'minQuantity': 99,
            'maxQuantity': 180,
            "weight": 0
        }])
        modifyDropTable('melvorTotH:Siren', 'monster', patchFlag, [{
            'id': "melvorTotH:Despair_Rune",
            'minQuantity': 19,
            'maxQuantity': 30,
            "weight": 0
        }])
        modifyDropTable('melvorTotH:PolarBear', 'monster', patchFlag, [{
        ...
        modifyDropTable('melvorTotH:Cockatrice', 'monster', patchFlag, [{
            'id': "melvorTotH:Decay_Bolts",
            'minQuantity': 24,
            'maxQuantity': 90,
            "weight": 0
        }])
        modifyDropTable('melvorF:Shaman', 'monster', patchFlag, [{
            'id': "melvorD:Chaos_Rune",
            'minQuantity': 4,
            'maxQuantity': 5,
            "weight": 0
        }])
        modifyDropTable('melvorF:Necromancer', 'monster', patchFlag, [{
            'id': "melvorD:Death_Rune",
            'minQuantity': 4,
            'maxQuantity': 5,
            "weight": 0
        }])
        modifyDropTable('melvorF:Elementalist', 'monster', patchFlag, [{
        ...
        modifyDropTable('melvorTotH:Burning_Chest', 'chest', patchFlag, [{
        ...
        modifyDropTable("melvorTotH:Phantom", "monster", patchFlag, [{
            "id": "melvorTotH:Ethereal_Longbow",
            "minQuantity": 0,
            "maxQuantity": 0,
            "weight": 40
        }])
        modifyDropTable("melvorTotH:Spectre", "monster", patchFlag, [{
            "id": "melvorTotH:Ethereal_Greataxe",
            "minQuantity": 0,
            "maxQuantity": 0,
            "weight": 40
        }])
        modifyDropTable("melvorTotH:Banshee", "monster", patchFlag, [{
    ...
    const patchUnavailableShopItems = (patchFlag) => {
        shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
            y.container.classList.remove('d-none')
        }))
        shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
            if (y.item.purchase.namespace === "hcco") y.container.classList.add('d-none')
        })) // Hide CO items by default, reveal them later
        ...
        shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
            if (exceptionItems.includes(y.item.purchase.id)) y.container.classList.remove('d-none')
        }))
        ...
        shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
            if (!shopItems.includes(y.item.purchase.id)) y.container.classList.add('d-none')
        }))
    }
    ...
    const patchLightRunesFromResupplies = (patchFlag) => {
        ...
        if (patchFlag) {
            ...
            resupplyShopItems.forEach(x => Object.defineProperty(x, 'isModded', {
                get() {
                    return true
                },
                configurable: true
            })); // Set modded flag to be true so that the game reads the custom description
            ...
            game.shop.purchases.getObjectByID("melvorF:Basic_Resupply").contains.items.push({
                'item': game.items.getObjectByID("melvorD:Light_Rune"),
                'quantity': 200
            })
            game.shop.purchases.getObjectByID("melvorF:Standard_Resupply").contains.items.push({
                'item': game.items.getObjectByID("melvorD:Light_Rune"),
                'quantity': 500
            })
            game.shop.purchases.getObjectByID("melvorF:Generous_Resupply").contains.items.push({
                'item': game.items.getObjectByID("melvorD:Light_Rune"),
                'quantity': 1000
            })
            game.shop.purchases.getObjectByID("melvorTotH:Plentiful_Resupply").contains.items.push({
                'item': game.items.getObjectByID("melvorD:Light_Rune"),
                'quantity': 4000
            })
            game.shop.purchases.getObjectByID("melvorTotH:Bountiful_Resupply").contains.items.push({
                'item': game.items.getObjectByID("melvorD:Light_Rune"),
                'quantity': 8500
            })
    ...
    const patchShopItemsForSummoning = (patchFlag) => {
        ...
        if (patchFlag) {
            ...
            if (!game.shop.purchases.getObjectByID(`${ctx.namespace}:Combat_Max_Skillcape`).purchaseRequirements.map(x => x.skill.id).includes('melvorD:Summoning')) {
                game.shop.purchases.getObjectByID(`${ctx.namespace}:Combat_Max_Skillcape`).purchaseRequirements.push({
                    "type": "SkillLevel",
                    "skill": game.summoning,
                    "level": 99
                });
                game.items.getObjectByID(`${ctx.namespace}:Combat_Max_Skillcape`).equipRequirements.push({
                    "type": "SkillLevel",
                    "skill": game.summoning,
                    "level": 99
                });
            ...
            if (!game.shop.purchases.getObjectByID(`${ctx.namespace}:Combat_Superior_Max_Skillcape`).purchaseRequirements.map(x => x.skill.id).includes('melvorD:Summoning')) {
                game.shop.purchases.getObjectByID(`${ctx.namespace}:Combat_Superior_Max_Skillcape`).purchaseRequirements.push({
                    "type": "SkillLevel",
                    "skill": game.summoning,
                    "level": 120
                });
                game.items.getObjectByID(`${ctx.namespace}:Combat_Superior_Max_Skillcape`).equipRequirements.push({
                    "type": "SkillLevel",
                    "skill": game.summoning,
                    "level": 120
                });
            ...
            shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
                if (shopItemsToModify.includes(y.item.purchase.id)) y.container.classList.remove('d-none')
            }))
        } else {
            // Add summoning requirements
            ...
            shopMenu.tabs.forEach(x => x.menu.items.forEach(y => {
                if (shopItemsToModify.includes(y.item.purchase.id)) y.container.classList.add('d-none')
            }))
        }
    }
    ...
    const patchSummoningDrops = (patchFlag) => {
        ...
        // Lightning spirit
        patchBoneTable("melvorTotH:LightningSpirit", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Lightning_Spirit",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:LightningMonkey", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Lightning_Spirit",
            "quantity": 55
        })
        patchBoneTable("melvorTotH:LightningGolem", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Lightning_Spirit",
            "quantity": 60
        })
        // Spider familiar
        // patchBoneTable("melvorTotH:RandomSpiderLair", patchFlag, { "id": "melvorTotH:Summoning_Familiar_Spider", "quantity": 50 })
        patchBoneTable("melvorTotH:ScouterSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:TrapperSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:WickedSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:BasherSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:EnforcerSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:GuardianSpider", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 50
        })
        patchBoneTable("melvorTotH:SpiderQueen", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 350
        })
        // Necromancer palace
        patchBoneTable("melvorTotH:CursedSkeletonWarrior", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Lightning_Spirit",
            "quantity": 120
        })
        patchBoneTable("melvorTotH:Beholder", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Siren",
            "quantity": 150
        })
        patchBoneTable("melvorTotH:DarkKnight", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spider",
            "quantity": 200
        })
        patchBoneTable("melvorTotH:Fiozor", patchFlag, {
            "id": "melvorTotH:Summoning_Familiar_Spectre",
            "quantity": 600
        })

        // Monsters
        addToDropTable('melvorF:LotsofEyes', 'monster', patchFlag, [{
            'id': "melvorF:Summoning_Familiar_Golbin_Thief",
            'weight': 300,
            'minQuantity': 10,
            'maxQuantity': 50
        }])
        addToDropTable('melvorF:ManyEyedMonster', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorF:StrangeEyedMonster', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorF:Eyes', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorF:SuperiorEyedMonster', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorF:EyeOfFear', 'monster', patchFlag, [{
            'id': "melvorF:Summoning_Familiar_Dragon",
            'weight': 300,
            'minQuantity': 10,
            'maxQuantity': 50
        }])
        addToDropTable('melvorTotH:Siren', 'monster', patchFlag, [{
            'id': "melvorTotH:Summoning_Familiar_Siren",
            'weight': 13800,
            'minQuantity': 15,
            'maxQuantity': 75
        ...
        addToDropTable('melvorAoD:BlindWarrior', 'monster', patchFlag, [{
            "id": "melvorAoD:City_Map",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 20
        }])
        addToDropTable('melvorAoD:BlindArcher', 'monster', patchFlag, [{
            "id": "melvorAoD:City_Map",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 16
        }])
        addToDropTable('melvorAoD:BlindMage', 'monster', patchFlag, [{
            "id": "melvorAoD:City_Map",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 16
        }])
        addToDropTable('melvorAoD:BlindGhost', 'monster', patchFlag, [{
            "id": "melvorAoD:City_Map",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 24
        ...
        addToDropTable('melvorAoD:SlimeShooter', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:AngryTeak', 'monster', patchFlag, [{
            "id": "melvorAoD:Ancient_Stone_Tablet",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 2000
        }])
        addToDropTable('melvorAoD:RagingMaple', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:MagicGolem', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:PoisonBloater', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:PossessedBarrel', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:CultMonster', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:Ritual_Chest', 'chest', patchFlag, [{
        ...
        addToDropTable('melvorAoD:ShipwreckBeast', 'monster', patchFlag, [{
            "id": "melvorAoD:Melantis_Clue_2",
            "minQuantity": 1,
            "maxQuantity": 1,
            "weight": 675
        }])
        addToDropTable('melvorAoD:CursedPirateCaptain', 'monster', patchFlag, [{
        ...
        addToDropTable('melvorAoD:CrystalBehemoth', 'monster', patchFlag, [{
        ...
        //Summoning
        addToDropTable('melvorAoD:PoisonLeecher', 'monster', patchFlag, [{
            "id": "melvorAoD:Summoning_Familiar_Barrier",
            "minQuantity": 10,
            "maxQuantity": 50,
            "weight": 2030
        }])
        addToDropTable('melvorAoD:PoisonRoamer', 'monster', patchFlag, [{
            "id": "melvorAoD:Summoning_Familiar_Barrier",
            "minQuantity": 10,
            "maxQuantity": 50,
            "weight": 1080
        }])
        addToDropTable('melvorAoD:PoisonSlime', 'monster', patchFlag, [{
            "id": "melvorAoD:Summoning_Familiar_Barrier",
            "minQuantity": 10,
            "maxQuantity": 50,
            "weight": 2550
    ...
    const patchCartographyEntryRequirements = (patchFlag) => {
        ...
        if (patchFlag) {
            ...
            game.combatAreas.getObjectByID("melvorAoD:EyeConicCave")._entryRequirements = [{
                "level": 5,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
                "type": "SkillLevel"
            }]
            game.combatAreas.getObjectByID("melvorAoD:MuckyCave")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:City_Map"),
                "type": "ItemFound"
            }, {
                "level": 30,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:TreeOvergrowth")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Old_Route_Chart"),
                "type": "ItemFound"
            }, {
                "level": 50,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:CollapsedCity")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Dusty_Book_of_Knowledge"),
                "type": "ItemFound"
            }, {
                "item": game.items.getObjectByID("melvorAoD:Navigation_Chart"),
                "type": "ItemFound"
            }, {
                "level": 65,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:LostTemple")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Torn_Scrolls"),
                "type": "ItemFound"
            }, {
                "level": 75,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:RitualSite")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Lost_Cursed_Text"),
                "type": "ItemFound"
            }, {
                "level": 95,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:ShipwreckCove")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Misty_Jewel"),
                "type": "ItemFound"
            }, {
                "level": 100,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:UnderwaterRuins")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Melantis_Clue_1"),
                "type": "ItemFound"
            }, {
                "item": game.items.getObjectByID("melvorAoD:Melantis_Clue_2"),
                "type": "ItemFound"
            }, {
                "item": game.items.getObjectByID("melvorAoD:Melantis_Clue_3"),
                "type": "ItemFound"
            }, {
                "item": game.items.getObjectByID("melvorAoD:Melantis_Clue_4"),
                "type": "ItemFound"
            }, {
                "level": 110,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.slayerAreas.getObjectByID("melvorAoD:CrystalCaves")._entryRequirements = [{
                ...
                "level": 40,
                "skill": game.skills.getObjectByID("melvorD:Slayer"),
                "type": "SkillLevel"
            }]
            game.slayerAreas.getObjectByID("melvorAoD:DarkQuarry")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Ancient_Stone_Tablet"),
                "type": "ItemFound"
            }, {
                "level": 55,
                "skill": game.skills.getObjectByID("melvorD:Summoning"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:EyeConicCave")._entryRequirements = [{
                "worldMap": game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor"),
                "pois": [game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor").pointsOfInterest.getObjectByID("melvorAoD:EyeConicCave")],
                "type": "CartographyPOIDiscovery"
            }]
            game.combatAreas.getObjectByID("melvorAoD:MuckyCave")._entryRequirements = [{
                "worldMap": game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor"),
                "pois": [game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor").pointsOfInterest.getObjectByID("melvorAoD:MuckyCave")],
                "type": "CartographyPOIDiscovery"
            }]
            game.combatAreas.getObjectByID("melvorAoD:TreeOvergrowth")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Old_Route_Chart"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:CollapsedCity")._entryRequirements = [{
                "worldMap": game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor"),
                "pois": [game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor").pointsOfInterest.getObjectByID("melvorAoD:GlaciaDungeonRuins")],
                "type": "CartographyPOIDiscovery"
            }]
            game.combatAreas.getObjectByID("melvorAoD:LostTemple")._entryRequirements = [{
                "item": game.items.getObjectByID("melvorAoD:Torn_Scrolls"),
            ...
            game.combatAreas.getObjectByID("melvorAoD:UnderwaterRuins")._entryRequirements = [{
                "worldMap": game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor"),
                "pois": [game.cartography.worldMaps.getObjectByID("melvorAoD:Melvor").pointsOfInterest.getObjectByID("melvorAoD:Melantis")],
                "type": "CartographyPOIDiscovery"
            }]
    ...
    const togglePetMarkUnlockRequirements = (patchFlag) => {
        game.pets.getObjectByID('melvorF:Mark').isCO = patchFlag
    }
    ...
    const atMaxMarkLevel = (familiar) => {
        return familiarLevelMap.get(familiar) >= Summoning.markLevels.length
    }
    const setFamiliarLevelMap = () => {
    ...
    const getCOItemList = () => {
        ...
        const monsterCheck = () => {
            ...
            coAreas = coAreas.filter(area => {
                if (area.hasBarrierMonsters) return summoningButtonValue();
                else return true
            })
    ...
    const toggleUnavailableMasteries = (patchFlag) => {
        ...
        if (patchFlag) {
            ...
            collectionLogTabs.forEach(x => {
                x.classList.remove('col-xl-20-perc');
                x.classList.add('col-xl-25-perc')
            })
        } else {
            ...
            collectionLogTabs.forEach(x => {
                x.classList.add('col-xl-20-perc');
                x.classList.remove('col-xl-25-perc')
            })
        }
    }
    const toggleUnavailableSkills = (patchFlag) => {
        ...
        if (patchFlag) {
            ...
            completionLogMenu.skills.forEach((value, key) => {
                if (!key.isCombat) value.classList.add('d-none')
            })
        } else {
            completionLogMenu.skills.forEach((value, key) => {
                if (key.isCombat) combatSkillsContainer.append(value);
                else nonCombatSkillsContainer.append(value);
            })
        }
    }
    ...
    const toggleUnavailablePets = (patchFlag) => {
        ...
        completionLogMenu.pets.forEach((value, key) => {
            if (!key.ignoreCompletion) value.classList.remove('d-none')
        }) // Reset
        if (patchFlag) {
            // game.pets.filter(x => x?.skill?.isCombat || x?._langHint?.category === "DUNGEON" || x?._langHint?.category === "SLAYER_AREA").forEach(x => x.isCO = true)
            completionLogMenu.pets.forEach((value, key) => {
                if (!key.isCO) value.classList.add('d-none')
            })
        }
    }
    const toggleUnavailableItems = (patchFlag) => {
        setCOFlags(patchFlag)
        completionLogMenu.items.forEach((value, key) => {
            if (!key.ignoreCompletion) value.classList.remove('d-none')
        }) // Reset
    ...
    const toggleUnavailableMonsters = (patchFlag) => {
        setCOFlags(patchFlag)
        completionLogMenu.monsters.forEach((value, key) => {
            if (!key.ignoreCompletion) value.classList.remove('d-none')
        }) // Reset
    ...
    Object.defineProperty(game.completion, 'totalProgressCO', {
        get() {
            return this.totalProgressMap.get(this.coNamespaceID);
        },
        configurable: true
    })
    ...
    await ctx.onCharacterLoaded(ctx => {
        ...
        const patchIngameFunctions = () => {
            ...
            game.monsters.forEach(monster => {
                ...
                monster.lootTable.drops = monster.lootTable.drops.map(drop => ({
                    ...drop,
                    weight: monster.lootChance * drop.weight
                })) // Modify all weights by their loot chance
                monster.lootTable.drops = [...monster.lootTable.drops, {
                    item: game.items.getObjectByID("melvorD:Empty_Equipment"),
                    maxQuantity: 0,
                    minQuantity: 0,
                    weight: newWeight,
                    vanillaWeight: newWeight
                }] // Add empty drop
        ...
        const patchMarkMechanics = () => {
            Object.defineProperty(Summoning, 'markLevels', { // Add 7th mark level
                get: () => {
                    return markButtonValue() ? [1, 6, 16, 31, 46, 61, 121] : [1, 6, 16, 31, 46, 61]
                }
            });
        ...
        const townshipCleanupPatch = () => {
            ...
            ctx.patch(Township, "addXP").replace(function(o, amount, masteryAction) {
                return
            }) // Make township give no XP
            ctx.patch(Township, "rollForPets").replace(function(o, interval) {
                return
            }) // Make township give no pet
            ...
            ctx.patch(TownshipTasks, "claimTaskRewards").before(function(task) {
                ...
                if (slayerRerollButtonValue())
                    ...
                    task.rewards.skillXP.forEach(({
                        ...
                        if (skill.id === "melvorD:Slayer") task.rewards.skillXP[i].quantity = Math.round(qty / 0.35)
                    })
                return task
            })
